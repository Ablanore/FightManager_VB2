...
Public Class formCreatePerso
    ...
    Private Sub btnSavePerso_Click(sender As Object, e As EventArgs) Handles btnSavePerso.Click
        ...
        Dim tabPower As New List(Of String)
        tabPower.Add("PowerBase")
        Dim unRecordPerso As New RecordPerso()
        unRecordPerso.NomPerso = txtNomPersonnage.Text
        unRecordPerso.TypePerso = ddlTypePerso.SelectedItem
        ...
        unRecordPerso.LesStuff = tabStuff
        unRecordPerso.LesPower = tabPower

        Select Case ddlTypePerso.SelectedItem
            Case "Mob"
                File.WriteAllText(ddlListeZone.SelectedItem & "\" & txtNomPersonnage.Text & ".json", JsonSerializer.Serialize(unRecordPerso))
            Case "Joueur"
    ...
    Sub lesTrucsDeDepart()
        ...
        Dim lstRaces = (From lstRace In RaceData.Races
                        Select New With {lstRace.IdRace, lstRace.NomRace}).ToList()
        ...
        'Chargement de TypePerso
        ddlTypePerso.Items.Add("Joueur")
        ddlTypePerso.Items.Add("Mob")

        'Chargement ddl des zones de scénario
        ddlListeZone.DataSource = My.Computer.FileSystem.GetDirectories(LaGrandeClasse.DossierDesZones)
        ddlListeZone.DisplayMember = "NomDossier"
    End Sub
    Sub ChargeStuff()
    ...
    Sub ChargeLabel()
        ...
        unPersonnage = New Personnage(txtNomPersonnage.Text, ddlTypePerso.SelectedItem, ddlClassePersonnage.SelectedValue, ddlRacePersonnage.SelectedValue, tabCarac, tabStuff, tabPower, txtPointExperience.Text)
        'penser à rectifier les paramètres pour le stuff et les power
    ...
    'Function ModRacial(IndexCarac As Short)
    ...
    '    End If
    'End Function
    'Function ModRacialCompetence(IndexCarac As Short)
    '    If ddlRacePersonnage.SelectedIndex = -1 Then
    '        Return 0
    '    Else
    '        Return (From leMod In RaceData.Races
