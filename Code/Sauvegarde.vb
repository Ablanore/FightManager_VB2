Public Class Sauvegarde
	...
	Public Sub New(nomParam As EnumSauvegarde, DemiLevelParam As Short, CaracParam As Short, laClasseParam As String, laRaceParam As String, leStuff As List(Of String))
...
Public Class Sauvegardes
	...
	Public Sub New(CaracteristiqueParam As Caracteristiques, DemiLevelParam As Short, laClasseParam As String, laRaceParam As String, leStuff As List(Of String))
		...
		Volonté = New Sauvegarde(Sauvegarde.EnumSauvegarde.Volonte, DemiLevelParam, CompareCarac(CaracteristiqueParam.Sagesse, CaracteristiqueParam.Charisme), laClasseParam, laRaceParam, leStuff)
	End Sub
