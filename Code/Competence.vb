...
Public Class Competence
    ...
    Public Sub New(nomParam As EnumCompetence, FormationParam As Boolean, DemiNiveauParam As Short, laRaceParam As String, CaracParam As Short, leStuff As List(Of String))
...
Public Class Competences
    ...
    Public Sub New(FormationParam As Boolean(), DemiNiveauParam As Short, laRaceParam As String, CaracParam As Caracteristiques, leStuff As List(Of String))
